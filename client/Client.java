...
public class Client extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        AvailableSensorsPanel.setBorder(javax.swing.BorderFactory.createTitledBorder("Avaible sensors"));
        ...
        ConnectedSensorsPanel.setBorder(javax.swing.BorderFactory.createTitledBorder("Connected sensors"));
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(SensorsInformationTabs, javax.swing.GroupLayout.DEFAULT_SIZE, 460, Short.MAX_VALUE)
                    .addGroup(layout.createSequentialGroup()
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(AvailableSensorsPanel, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addComponent(SensorsInformationTabs, javax.swing.GroupLayout.DEFAULT_SIZE, 222, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    private void connectToSensorActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        // Dodanie nowego sensora na liście connected, jeżeli któryś jest zaznaczony oraz nie ma go już na liście connected
        if (!AvailableSensorsList.isSelectionEmpty() && ConnectedSensorsListModel.indexOf(AvailableSensorsList.getSelectedValue().toString())<0) {

            // TODO: wybieranie i subskrypcja kanału
            ConnectedSensorsListModel.addElement(AvailableSensorsList.getSelectedValue().toString());
            ...
            jTextArea1.setText(AvailableSensorsList.getSelectedValue().toString());
            jScrollPane.setViewportView(jTextArea1);
            SensorsInformationTabs.addTab(AvailableSensorsList.getSelectedValue().toString(), jScrollPane);
        }

    }

    private void disconnectFromSensorActionPerformed(java.awt.event.ActionEvent evt) {
        // Dodanie nowego sensora na liście connected, jeżeli któryś jest zaznaczony oraz nie ma go już na liście connected
        if (!ConnectedSensorsList.isSelectionEmpty()) {
            SensorsInformationTabs.removeTabAt(ConnectedSensorsListModel.indexOf(ConnectedSensorsList.getSelectedValue().toString()));
            ConnectedSensorsListModel.removeElement(ConnectedSensorsList.getSelectedValue().toString());
        ...
        while (true) {
            try{
                ...
                if(SensorsInformationTabs.getTabCount()>0){
                    javax.swing.JScrollPane scrollPane = (javax.swing.JScrollPane) SensorsInformationTabs.getSelectedComponent();
                    javax.swing.JViewport viewPort = (javax.swing.JViewport) scrollPane.getViewport();
                    javax.swing.JTextArea textArea = (javax.swing.JTextArea) viewPort.getView();
